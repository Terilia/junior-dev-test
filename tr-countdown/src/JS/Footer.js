...
class Footer extends Component {
	render() {
	  return (
		<Container>
			<Row className="legal-container">
				<Col className="legal-image"><Image src={ESRBLogo}/></Col>
				<Col className="legal-image"><Image src={XboxLogo}/></Col>
				<Col className="legal-image"><Image src={Ps4Logo}/></Col>
				<Col className="legal-image"><Image src={SteamLogo}/></Col>
				<Col className="legal-image"><Image src={PCLogo}/></Col>
			</Row>
			<Row>
				<Col className="legal-image"><Image src={CrystalLogo}/></Col>
				<Col className="legal-image"><Image src={SquareEnixLogo}/></Col>
				<Col className="legal-image"><Image src={EidosLogo}/></Col>
			</Row>
			<Row>
			...
			<Row className="justify-content-md-center link-list">
				...
				<Col md="auto" className="bottom-nav colon">●</Col>
